...
func Schedule(db qrm.DB) (Output, error) {
	// err := table.StudentStudentGroupRel.
	// 	SELECT(table.StudentStudentGroupRel.StudentEmail, table.StudentGroup.EventID).
	// 	FROM(
	// 		table.StudentStudentGroupRel.INNER_JOIN(
	// 			table.StudentGroup,
	// 			table.StudentGroup.ID.EQ(table.StudentStudentGroupRel.StudentGroupID),
	// 		),
	// 	).
	// 	Query(db)
	// if err != nil {
