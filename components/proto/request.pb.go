...
type Time struct {
	...
	Divisions []int32 `protobuf:"varint,2,rep,packed,name=divisions,proto3" json:"divisions,omitempty"` //length in minutes
}
...
type Constraints struct {
	...
	ExamLength int32 `protobuf:"varint,2,opt,name=examLength,proto3" json:"examLength,omitempty"` //length in minutes
}
